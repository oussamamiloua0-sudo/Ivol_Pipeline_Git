...
def main():
    ...
    # ✅ Ensure get_engine() uses the resolved URL
    ...
    # ✅ SSL-safe engine from your helper (DO REQUIRE SSL)
    engine = get_engine()
